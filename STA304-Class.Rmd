...
Tidyverse functions `arrange()`, `filter()`, `glimpse()`, `group_by()`, `mutate()`, `select()`, `summarise()`, and many more: https://dplyr.tidyverse.org/reference/index.html
...
After class (try on your own): Run a hypothesis test to see if Aang or Katara mentions Appa more. (Note, the results may vary based off the employed test)
