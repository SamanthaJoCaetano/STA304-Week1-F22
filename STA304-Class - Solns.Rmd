...
Try on your own: Run a hypothesis test to see if Aang or Katara mentions Appa more. (Note, the results may vary based off the employed test)
...
ggplot(data = avatar_data, aes(x=imdb_rating)) +
  geom_histogram(colour="green", fill="yellow",
                 bins=10) +
  labs(title = "Histogram of IMDb rating", x="IMDb rating")
